...
<table style="width:100%" class="table1">
  <tr>
    <td style="padding:10px"><h2 style="font-size:150%"><a href="Fresh.php?var=fresh">Fresh</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="Fresh.php?var=bullshit">Bullshit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="fresh.php?var=truth" >Truth</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="notices.php" >Gossip</a></td></h2>
...
echo $strings;
echo "<hr></td></tr>";
echo "<tr><td align='center'><span class='buttong'><a href='good.php?id=".$id."'>GOOD :) ".$row['good']."</a></span>&emsp;&emsp;<span class='buttonb'><a href='bad.php?id=".$id."' >BAD :( ".$row['bad']."</a></span>";
echo "<br><br></td></tr>";
...
echo "<img src='userprofile/".$rowc['creator'].".jpg' width='40px' height='40px'>&nbsp;".$rowc['creator']."&nbsp;:&nbsp;".$rowc['body']."<div align='right'>";
echo "<a href='deletecomment.php?id=".$rowc['id']."'>delete</a>";
echo "<hr></div>";
...
echo "&emsp;&emsp;&nbsp;<img src='sign.jpg' width='40px' height='40px'>&ensp;<img src='userprofile/".$rowd['creator'].".jpg' width='40px' height='40px'>&nbsp;".$rowd['creator']."&nbsp;:&nbsp;".$rowd['body']."<div align='right'><a href='deletesubcomment.php?id=".$rowc['id']."'>delete</a></div><hr>";
}
